...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_REACT_APP_WALLETCONNECT_PROJECT_ID: z.string(),
  },
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_REACT_APP_WALLETCONNECT_PROJECT_ID:
      process.env.NEXT_PUBLIC_REACT_APP_WALLETCONNECT_PROJECT_ID,
